describe('koapp-tictactoe controller', function() {
  beforeEach(function() {
    browser.driver.manage().window().setSize(400, 666);
    browser.get('http://localhost:9001/#/menu-abcd/koapp-tictactoe');
  });

  it('should load module', function() {
    expect(element(by.css('.koapp-Tictactoe'))).toBeDefined();
  });
